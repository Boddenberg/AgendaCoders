...
//            new AgendaDAO().adicionarDados(mock);
            ...
            System.out.println(teste.get(1).getTipoContato());
            System.out.println(teste.get(1).getEnderecos().get(1).getTipoEndereco());
            System.out.println(teste.get(1).getTelefones().get(1).getTipoTelefone());
